import 'package:artbooking/components/resizer/corner_button.dart';
...
class Resizer extends StatefulWidget {
  ...
  final void Function(Size endSize, Size originalSize, DragEndDetails details)?
      onResizeEnd;

  final void Function(Size endSize, Size originalSize)? onResizeCancel;

  /// Fires after `onTap` on `CornerButton`.
...
class _ResponsiveUtil extends State<Resizer> with WidgetsBindingObserver {
            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: CornerButton(
                  ...
                  onDoubleTap: () => reset(),
                  onResizeCancel: () {
                    widget.onResizeCancel?.call(wrapperSize!, originalSize!);
                  },
                  onResizeEnd: (DragEndDetails details) {
                    widget.onResizeEnd
                        ?.call(wrapperSize!, originalSize!, details);
                  },
                ),
              ),
