...
class HomePageCurated extends StatefulWidget {
  const HomePageCurated({Key? key}) : super(key: key);

  @override
  _HomePageCuratedState createState() => _HomePageCuratedState();
}

class _HomePageCuratedState extends State<HomePageCurated> {
