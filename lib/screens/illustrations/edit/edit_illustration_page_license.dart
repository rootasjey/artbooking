...
class EditIllustrationLicenses extends StatefulWidget {
  ...
  const EditIllustrationLicenses({
    Key? key,
  ...
  @override
  _EditIllustrationLicensesState createState() =>
      _EditIllustrationLicensesState();
}

class _EditIllustrationLicensesState extends State<EditIllustrationLicenses> {
